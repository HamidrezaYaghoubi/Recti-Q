...
#SBATCH --job-name=q_bdd_rectiq_on_nt
...
CONFIG_PATH="${CONFIG_PATH:-configs/quantize_bdd100k_yolo_finetuned_rectiq_enabled_no_teacher.yaml}"
TIMESTAMP=$(date -u +"%Y%m%dT%H%M%SZ")
RUN_LOG="$ROOT_DIR/logs/quant_bdd_rectiq_enabled_no_teacher_${TIMESTAMP}.log"
